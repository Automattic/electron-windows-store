...
module.exports = function (program) {
  return new Promise((resolve, reject) => {
    ...
    let destination = path.join(program.outputDirectory, `${program.packageName}${program.packageVersion ? ' ' + program.packageVersion : ''}${program.devCert && program.devCert.toLowerCase() === 'nil' ? ' unsigned' : ''}.appx`)
